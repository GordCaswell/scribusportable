...
user in an INI file next to ScribusPortable.exe called ScribusPortable.ini.
...
copy AppNamePortable.ini from this directory to ScribusPortable.ini next to
ScribusPortable.exe. The options in the INI file are as follows:
